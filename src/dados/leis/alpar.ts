...
const alienPar:ILei = {
	...
	conteudo: `
        ...
        <p><span class="artigo">Art. 2º.</span> Considera-se ato de alienação parental a interferência na formação psicológica da criança ou do adolescente promovida ou induzida por um dos genitores, pelos avós ou pelos que tenham a criança ou adolescente sob a sua autoridade, guarda ou vigilância para que repudie genitor ou que cause prejuízo ao estabelecimento ou à manutenção de vínculos com este. </p>
        ...
        <p><span class="artigo">Art. 3º.</span> A prática de ato de alienação parental fere direito fundamental da criança ou do adolescente de convivência familiar saudável, prejudica a realização de afeto nas relações com genitor e com o grupo familiar, constitui abuso moral contra a criança ou o adolescente e descumprimento dos deveres inerentes à autoridade parental ou decorrentes de tutela ou guarda. </p>
        
        <p><span class="artigo">Art. 4º.</span> Declarado indício de ato de alienação parental, a requerimento ou de ofício, em qualquer momento processual, em ação autônoma ou incidentalmente, o processo terá tramitação prioritária, e o juiz determinará, com urgência, ouvido o Ministério Público, as medidas provisórias necessárias para preservação da integridade psicológica da criança ou do adolescente, inclusive para assegurar sua convivência com genitor ou viabilizar a efetiva reaproximação entre ambos, se for o caso. </p>
        ...
        <p><span class="artigo">Art. 5º.</span> Havendo indício da prática de ato de alienação parental, em ação autônoma ou incidental, o juiz, se necessário, determinará perícia psicológica ou biopsicossocial. </p>
        
        <p>§ 1º. O laudo pericial terá base em ampla avaliação psicológica ou biopsicossocial, conforme o caso, compreendendo, inclusive, entrevista pessoal com as partes, exame de documentos dos autos, histórico do relacionamento do casal e da separação, cronologia de incidentes, avaliação da personalidade dos envolvidos e exame da forma como a criança ou adolescente se manifesta acerca de eventual acusação contra genitor. </p>
        
        <p>§ 2º. A perícia será realizada por profissional ou equipe multidisciplinar habilitados, exigido, em qualquer caso, aptidão comprovada por histórico profissional ou acadêmico para diagnosticar atos de alienação parental. </p>
        
        <p>§ 3º. O perito ou equipe multidisciplinar designada para verificar a ocorrência de alienação parental terá prazo de 90 (noventa) dias para apresentação do laudo, prorrogável exclusivamente por autorização judicial baseada em justificativa circunstanciada. </p>
        
        <p><span class="artigo">Art. 6º.</span> Caracterizados atos típicos de alienação parental ou qualquer conduta que dificulte a convivência de criança ou adolescente com genitor, em ação autônoma ou incidental, o juiz poderá, cumulativamente ou não, sem prejuízo da decorrente responsabilidade civil ou criminal e da ampla utilização de instrumentos processuais aptos a inibir ou atenuar seus efeitos, segundo a gravidade do caso: </p>
        ...
        <p><span class="artigo">Art. 7º.</span> A atribuição ou alteração da guarda dar-se-á por preferência ao genitor que viabiliza a efetiva convivência da criança ou adolescente com o outro genitor nas hipóteses em que seja inviável a guarda compartilhada. </p>
        
        <p><span class="artigo">Art. 8º.</span> A alteração de domicílio da criança ou adolescente é irrelevante para a determinação da competência relacionada às ações fundadas em direito de convivência familiar, salvo se decorrente de consenso entre os genitores ou de decisão judicial. </p>
        
        <p><span class="artigo">Art. 9º.</span> (VETADO) </p>
        
        <p><span class="artigo">Art. 10.</span> (VETADO) </p>
        
        <p><span class="artigo">Art. 11.</span> Esta Lei entra em vigor na data de sua publicação. </p>
        
        <p>Brasília, 26 de agosto de 2010; 189º. da Independência e 122º. da República. </p>
        
        <p id=assinaturas>LUIZ INÁCIO LULA DASILVA<br><i>
        Luiz Paulo Teles Ferreira Barreto<br>
        Paulo de Tarso Vannuchi<br>
        José Gomes Temporão</p>
    `,
}
export default alienPar
